          ...
          <div className="flex items-center gap-10">
            {navLinks.map((link) => (
              <a 
                key={link.name} 
                href={link.href}
                className={`text-[var(--text-tiny)] uppercase tracking-[0.3em] font-[var(--weight-black)] transition-all relative py-2 ${
                  activeSection === link.id ? 'text-accent' : 'text-white/40 hover:text-white'
                }`}
              >
                {link.name}
